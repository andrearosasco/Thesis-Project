...
def run(config):
    ...
    # Data
    trainset = SplitCIFAR100(dset='train', valid=data_config['valid'], transform=data_config['train_transform'], classes=list(range(10)))
    validset = SplitCIFAR100(dset='valid', valid=data_config['valid'], transform=data_config['train_transform'], classes=list(range(10)))
